...
class TestControl:    
    ...
    def get_location(self, clusters):
        ...
        for i, pc in enumerate(clusters.clusters):
            ...
            #print("Cluster "+ str(i) + ": # points " + str(num_points))
            sum_x = 0
            #sum_y = 0
            min_y = 9999.9
            sum_z = 0
...
if __name__=='__main__':
    ...
    names = {
        ...
        "What color is it?" : 8, 
        "what objects would you use to pack a lunch?": 12, 
        "thank you for yor time you can remove the headset": 13
    }
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if (keys[pygame.K_0] or keys[pygame.K_1] or keys[pygame.K_2] or keys[pygame.K_3] or
                    ...
                    if (0<= key < len(tc.locations)):
                        ...
                        p.point.y = tc.locations[key][1]-0.3
